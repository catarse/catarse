...
O Relsi Hur Maron fez um ótimo post explicando passo a passo como fazer o código do Catarse rodar na sua máquina local. Veja o post em http://www.tuxtilt.com/catarse-plataforma-de-crowdfunding-open-source/ e se divirta!

Muito obrigado ao Relsi pelo post e por se aventurar em terras não documentadas :)
