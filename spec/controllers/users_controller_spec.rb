...
RSpec.describe UsersController, type: :controller do
  ...
  describe "GET unsubscribe_notifications" do
    context "when user is loged" do
      ...
      it { is_expected.to redirect_to edit_user_path(current_user, anchor: 'notifications')  }
    end
    ...
    context "when user is not loged" do
      ...
      it { is_expected.not_to redirect_to edit_user_path(current_user, anchor: 'notifications')  }
    end
  end
