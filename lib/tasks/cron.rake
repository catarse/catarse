namespace :cron do
  ...
  task refresh_stats_materialized_view: :environment do
    ...
    views = %w(
      public.moments_project_start public.moments_project_start_inferuser stats.financeiro_control_panel_simplificado stats.financeiro_int_payments_2016_simplificado
