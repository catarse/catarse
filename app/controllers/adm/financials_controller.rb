        ...
        csv_string = CSV.generate do |csv|
          ...
          projects.each do |project|
            ...
            csv << [project.name,
                    ...
                    "#{view_context.number_to_currency project.total_payment_service_fee }",
                    "#{view_context.number_to_currency catarse_fee } (#{view_context.number_to_currency project.pledged - catarse_fee, unit: 'R$', precision: 0, delimiter: '.'})",
                    "#{view_context.number_to_currency project.pledged*0.87 }",
