class UserPolicy < ApplicationPolicy
  ...
  def permitted_attributes
    u_attrs = [:current_password, :password, :subscribed_to_new_followers, :subscribed_to_project_post, bank_account_attributes: [:id, :input_bank_number, :bank_id, :name, :agency, :account, :owner_name, :owner_document, :account_digit, :agency_digit] ]
