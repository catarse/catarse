...
class SubscriptionMonthlyReportForProjectOwner < ActiveRecord::Base
  ...
  def self.to_csv
    attributes = ['Nome completo',	'Nome público', 'CPF', 'Email perfil Catarse',	'Valor do apoio',	'Título da recompensa',	'Descrição da recompensa', 'Meio de pagamento',	'Data do pagamento', 'Data de confirmação do pagamento', 'Status do pagamento',	'ID do usuário', 'Anônimo', 'Rua', 	'Número',	'Complemento', 'Bairro',	'Cidade',	'Estado',	'CEP']
