...
class ProjectsController < ApplicationController
  ...
  def index
    index! do
      ...
      @recent = current_site.present_projects.includes(:user, :category).visible.not_home_page.not_recommended.not_successful.not_unsuccessful.where("projects.user_id <> 7329").order('created_at DESC').limit(12).all
