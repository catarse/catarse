...
Atualmente, uma série de funcionalidades estão sem testes de aceitação. Se você não sabe como começar, uma boa maneira pode ser contribuindo com testes de aceitação :) qualquer dúvida, estou à disposição no link:danielweinmann@gmail.com.
