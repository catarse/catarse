                    ...
                    m('.w-row', [
                        ...
                        m('.w-col.w-col-8', [
                            m('.fontsize-small.link-hidden.fontweight-semibold.u-marginbottom-10.lineheight-tight[itemprop="name"]', [
                                m(
                                    `a.link-hidden${attrs.isDark ? '.link-hidden-white' : ''}[href="${_.isNull(userDetail.deactivated_at) ? `/users/${userDetail.id}` : 'javascript:void(0);'
                                    }"]`,
                                    {
                            ...
                            !_.isNull(userDetail.deactivated_at)
                                ...
                                : m('ul.w-hidden-tiny.w-hidden-small.w-list-unstyled.fontsize-smaller.fontweight-semibold.u-margintop-20.u-marginbottom-20', [
                                    !_.isEmpty(userDetail.facebook_link)
                                        ? m('li', [
                                            m(
                                                `a.link-hidden${attrs.isDark ? '.link-hidden-white' : ''}[itemprop="url"][href="${userDetail.facebook_link
                                                }"][target="_blank"]`,
                                                {
                                    ...
                                    !_.isEmpty(userDetail.twitter_username)
                                        ? m('li', [
                                            m(
                                                `a.link-hidden${attrs.isDark ? '.link-hidden-white' : ''}[itemprop="url"][href="https://twitter.com/${userDetail.twitter_username
                                                }"][target="_blank"]`,
                                                {
                                                    onclick: h.analytics.event({
                                                        cat: 'project_view',
                                    ...
                                    _.map(userDetail.links, link => {
                                        ...
                                        return !_.isEmpty(parsedLink.hostname)
                                            ? m('li', [
                                                m(
                                                    `a.link-hidden${attrs.isDark ? '.link-hidden-white' : ''}[itemprop="url"][href="${link.link
                                                    }"][target="_blank"]`,
                                                    {
                                                        onclick: h.analytics.event({
                                                            cat: 'project_view',
                                ...
                                ? [
                                    !_.isNull(userDetail.deactivated_at)
                                        ...
                                        : m(UserFollowBtn, {
                                            ...
                                            disabledClass: `a.w-button.btn.btn-terciary${attrs.isDark ? '.btn-terciary-negative' : ''
                                                }.btn-small.u-marginbottom-10`,
