...
class Reward < ActiveRecord::Base
  ...
  def deliver_at_cannot_be_in_the_past
    ...
    self.deliver_at.present? && ( self.project.expires_at.present? ? self.deliver_at < self.project.expires_at.beginning_of_month : self.deliver_at < Time.current.beginning_of_month )
  end
