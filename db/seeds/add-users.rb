...
puts "Adding Uservoice.com settings..."
  ...
  Configuration.find_or_create_by(name: 'uservoice_subdomain').update(value: 'dummy_domain.uservoice.com')
  Configuration.find_or_create_by(name: 'uservoice_sso_key').update(value: 'dummy_uservoice_sso_key')
