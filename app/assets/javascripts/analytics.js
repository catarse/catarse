...
*/
  ...
  function _event(eventObj, fn, ignoreGA) {
    if (eventObj) {
      try {
        ...
        var gaTracker = null;
        ignoreGA = ignoreGA || typeof gtag !== 'function';
        ...
        if (!ignoreGA && typeof gtag != 'undefined') {
          //https://developers.google.com/analytics/devguides/collection/analyticsjs/sending-hits#the_send_method
          gtag('event', eventObj.act, {
            'event_category': eventObj.cat,
            'event_label': eventObj.lbl
          });
  ...
  function _pageView(firstPageView) {
    ...
    pvto = setTimeout(function () {
      ...
      if (!firstPageView && typeof gtag != 'undefined') {
        gtag('event', 'pageview', {
