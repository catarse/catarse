...
function setupWrap(customAttr: { [key:string] : any }) {
    try {
        ...
        let userParam = m.route.param('user_id') || app.getAttribute('data-userid') || parameters.user_id || customAttr?.user_id || (isLoggedIn(currentUser) && currentUser && currentUser.id)
