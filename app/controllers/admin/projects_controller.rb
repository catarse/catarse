class Admin::ProjectsController < Admin::BaseController
  ...
  has_scope :by_id, :pg_search, :user_name_contains, :with_state, :by_category_id, :by_goal, :order_by
  has_scope :between_created_at, :between_expires_at, :between_online_date, :between_updated_at, using: [ :start_at, :ends_at ], allow_blank: true
